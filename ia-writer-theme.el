...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(link ((,class (:foreground ,lt-second :underline (:color ,lt-linum :style line)))
           (((background dark)) (:foreground ,dk-muted :underline (:color ,dk-comment :style line)))))
   `(link-visited ((,class (:foreground ,lt-comment :underline (:color ,lt-linum :style line)))
                   (((background dark)) (:foreground ,dk-second :underline (:color ,dk-comment :style line)))))
   ...
   `(org-headline-done ((,class (:foreground ,lt-comment))
                        (((background dark)) (:foreground ,dk-comment))))
   `(org-link ((,class (:foreground ,lt-second :underline (:color ,lt-linum :style line)))
               (((background dark)) (:foreground ,dk-muted :underline (:color ,dk-comment :style line)))))
